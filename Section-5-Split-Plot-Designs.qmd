...
Factor A laid out in 3 randomized complete blocks
:::
...
Factor A laid out in 3 randomized complete blocks, with each A unit subdivided into two subunits.
:::
...
![SAS output from PROC MIXED for the analysis of a split-plot](splitplotanova.jpg){fig-alt="The figure provided the output from SAS for the analysis of a split-plot carried out as a CRD. The Expected Mean Squares show the different error terms." width="80%"}
...
![PROC MIXED analysis of the antibiotic capsule data](antibiotic%20mixed.jpg){fig-alt="The figure shows the output of the PROC MIXED analysis of the antibiotic capsule data." width="90%"}
...
## More Complicated Split-Plot Designs
